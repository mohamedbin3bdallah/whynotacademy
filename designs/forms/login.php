...
<form action="" method="POST">
	<table class="table" align="center">
		...
		<tr><td id="noborder"><input type="submit" class="btn btn-info" name="loginsubmit" id="loginsubmit" class="greenButton" value="<?php language("login"); ?>" disabled/> <!-- <a href="pages/forgotpassword.php"><?php language(" ").language("forgotpass"); ?></a> --> </td></tr>
	</table>
</form>
</div>
</div>