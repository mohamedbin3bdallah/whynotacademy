...
<!--start-home-->
		    ...
		    <!-- <div class="header-top">
			  ...
			  <div class="container">  
			     <div class="main">	
				   <div class="wht-head">	
					 <div class="logo">
						<a href="index.php"><img src="uploads/logo.jpg" width="35px"></a>
					 </div>
					<!--top-nav-->
			 ...
			 <div id="aboutme">
				<div class="about" id="gallery" style="border-radius: 5%;">
				  <h3 class="tittle"><?php language('about'); ?></h3>
				   <div class="ab-top">
		...
		<div class="gallery" id="about" style="border-radius: 5%;">
			<h3 class="tittle two"><?php language('universitycourses'); ?></h3>
			<?php if(!empty($universitycourses)) { ?>
			<div class="gallery-bottom">
			 <?php for($i=0;$i<count($universitycourses);$i++) { 
				$faculty[$i] = getNameByID('faculties','id',$universitycourses[$i]['facultyid'],$lang_file);
				$university[$i] = getNameByID('universities','id',$universitycourses[$i]['universityid'],$lang_file);
			 ?>
			 <div class="view view-fifth" style="height: 300px;">
                    <a href="uploads/universitycourses/thumbnail/<?php echo $universitycourses[$i]['image']; ?>" class="b-link-stripe b-animate-go  swipebox"  title="<?php echo $universitycourses[$i]['title'].' - '.$faculty[$i].' - '.$university[$i]; ?>"><img src="uploads/universitycourses/thumbnail/<?php echo $universitycourses[$i]['image']; ?>" alt="<?php echo $universitycourses[$i]['title'].' - '.$faculty[$i].' - '.$university[$i]; ?>" class="img-responsive">
						<div class="mask" style="height: 300px;">
							<h2><?php echo $universitycourses[$i]['title'].' - '.$faculty[$i].' - '.$university[$i]; ?></h2>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header" style="background-color: #18c9d2; color: #fff;">
						<?php echo $universitycourses[$i]['title'].' - '.$faculty[$i].' - '.$university[$i]; ?>
				...
				<?php if(count($universitycourses) > 3) { ?>
   ...
   <!--//end-teachers-->
		...
		<!--contact-->
			<div class="contact" id="contact" style="border-radius: 5%;">
					<h3 class="tittle two"><?php language('contact'); ?></h3>
						<div class="contact-top">
							<div class="col-md-8 <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { echo ' col-md-pull-4 '; } ?> contact-top-right">
								<form action="message.php" method="POST">
									<input type="text" <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { echo ' dir="rtl" '; } ?> class="text" name="name" placeholder="<?php language('name'); ?>">
									 <input type="email" <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { echo ' dir="rtl" '; } ?> class="text" name="email" placeholder="<?php language('email'); ?>">
									<textarea name="message" <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { echo ' dir="rtl" '; } ?> placeholder="<?php language('message'); ?>"></textarea>
							...
							<div class="contact-top-one">
								<h4 <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { ?>style="text-align: right;" dir="rtl"<?php } ?>><?php language('address'); ?>:</h4>
							...
							<div class="contact-top-one">
								<h4 <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { ?>style="text-align: right;" dir="rtl"<?php } ?>><?php language('phone'); ?>:</h4>
							...
							<div class="contact-top-one">
								<h4 <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { ?>style="text-align: right;" dir="rtl"<?php } ?>><?php language('email'); ?>:</h4>
