...
#aboutme,#universitycourses,#othercourses,#contactus,#search,#booking,.copy
{
	margin-top: 5%;
}
...
.top-menu ul li{
 display: inline-block;
  ...
  font-weight: 900;
  vertical-align: top;
  border-right: 2px dotted #660505;
}
/* Effect 16: fall down */
.cl-effect-16 a {
	color: #6f8686;
...
/*--start-banner--*/
.banner {
  background: url(../uploads/carousel/banner.jpg) no-repeat center top;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
...
.banner-slider
	{
		background-color: rgba(0, 0, 0, 0.4); min-height: 505px;
	}
.banner-info {
   width: 45%;
   margin: 13% auto 0;
...
.callbacks_nav.next {
  left: auto;
	...
	<?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { ?>right: 0px;
	<?php } else { ?>right: 9px;<?php } ?>
 }
 .callbacks_nav.prev {
	right: auto;
...
.view {
  ...
  height: 200px;
  margin: 20px 26px;
  <?php if(isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar') { ?>float: right;
  <?php } else { ?>float: left;<?php } ?>
  /*border: 10px solid #099DA5;*/
  border: 10px solid #056166;
  overflow: hidden;
  position: relative;
  text-align: center;
  cursor: default;
...
.view-fifth .mask {
	...
	background-color: rgba(35, 121, 125, 0.89);
	/*background-color: rgba(161, 8, 8, 0.89);*/
...
.contact-top-right form input[type="text"], .contact-top-right form input[type="email"], .contact-top-right form input[type="password"]{ 
  width: 99%;
  background-color: rgba(0, 0, 0, 0.22);
  color: #000;
  outline: none;
...
.universitycourses-link,.universitycourses-link:visited {
   border: none;
  outline: none;  
  text-decoration: none;
  color: #fff;
...
.othercourses-link,.othercourses-link:visited {
   border: none;
  outline: none;
  text-decoration: none;
  color: #18C9D2;
...
@media (max-width:1280px){
	...
	.banner-slider
	{
		background-color: rgba(0, 0, 0, 0.4); min-height: 484px;
	}
}
@media (max-width:1024px){
	...
	.banner-slider
	{
		background-color: rgba(0, 0, 0, 0.4); min-height: 423px;
	}
	.view {
	  width: 283px;
	  height: 200px;
...
@media (max-width:800px){
	...
	.banner-slider
	{
		background-color: rgba(0, 0, 0, 0.4); min-height: 363px;
	}
	.service-grid {
	  padding: 0;
	  width: 49%;
...
@media (max-width:640px){
	...
	.banner-slider
	{
		background-color: rgba(0, 0, 0, 0.4); min-height: 284px;
	}
	.callbacks_tabs {
	  bottom: -17%;
	  left: 41%;
...
@media (max-width:480px){
	...
	.banner-slider
	{
		background-color: rgba(0, 0, 0, 0.4); min-height: 239px;
	}
	.service-grid p {
	  font-size: 0.83em;
	  width: 96%;
...
@media (max-width:320px){
	...
	.banner-slider
	{
		background-color: rgba(0, 0, 0, 0.4); min-height: 174px;
	}
	.banner-info {
	  width: 100%;
	  margin: 5% auto 0;
