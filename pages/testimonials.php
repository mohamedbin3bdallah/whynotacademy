...
if(isset($_COOKIE['userid']))
{
	...
	include('../develops/testimonials.php');
	if($lang_file == "ar")
...
<?php //if(checkBlockUserPri($userid,$testimonials) && checkMeCirclePri($userid,$profileid)) { ?>
<?php include('../designs/containers/testimonials.php'); ?>
