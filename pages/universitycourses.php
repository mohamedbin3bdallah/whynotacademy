...
if(isset($_COOKIE['userid']))
{
	...
	include('../develops/universitycourses.php');
	if($lang_file == "ar")
...
<script type="text/javascript" src="../js/universitycourses.js"></script>
</head>
<body>
<div class="container">
<?php include('../designs/containers/universitycourses.php'); ?>
</div>
</body>
</html>
<?php
